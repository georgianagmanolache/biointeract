...
We also release the automated [data collection pipeline](https://anonymous.4open.science/r/biointeract-E615/data_collection_pipeline/README.md) which enables recreation of the dataset.
